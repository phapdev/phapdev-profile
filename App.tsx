...
import { Home, User, Layers, Mail, Terminal as TerminalIcon } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  return (
    <main className="h-screen w-screen overflow-hidden bg-base font-sans relative flex">
      <AnimatedBackground />
      <Navigation
        navItems={navItems}
